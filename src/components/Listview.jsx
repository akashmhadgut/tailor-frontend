        ...
        <div className="flex justify-between items-start gap-2">
            ...
            <div className="flex flex-col gap-2.5 overflow-hidden">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-[12px] text-gray-600 font-mono tracking-wide">#{order.orderId}</span>
                </div>
            ...
            <div className="flex items-start gap-2">
                ...
                <div className="flex flex-col items-end gap-2.5 max-w-[180px]"> 
                    {/* Status Dropdown */}
                    <div className="relative">
                        <select
                            ...
                            className={`text-[10px] uppercase tracking-wider px-2.5 py-1 rounded-md border focus:outline-none focus:ring-2 focus:ring-opacity-50 cursor-pointer transition-colors ${style.select}`}
                        >
                            {columns.map(col => (
                    ...
                    <div className="flex flex-wrap justify-end items-center gap-1.5 w-full">
                        <span className="text-[10px] font-semibold text-gray-600 bg-white/60 backdrop-blur-sm px-2 py-0.5 rounded-md border border-gray-200/50 shadow-sm whitespace-nowrap">
                                {order.type} <span className="text-gray-500 font-normal">×{order.quantity}</span>
                        </span>

                        <div className="flex items-center gap-1 text-[10px] bg-white/60 backdrop-blur-sm px-2 py-0.5 rounded-md border border-gray-200/50 shadow-sm text-gray-600 font-medium whitespace-nowrap">
