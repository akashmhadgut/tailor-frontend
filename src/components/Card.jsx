            ...
            <div className="flex items-start gap-2">
                ...
                <div className="flex flex-col items-end gap-2.5">
                    ...
                    <div className="flex items-center gap-1.5">
                        ...
                        <div className="flex items-center gap-1 text-[10px] bg-white/60 backdrop-blur-sm px-2 py-0.5 rounded-md border border-gray-200/50 shadow-sm text-gray-600 font-medium">
