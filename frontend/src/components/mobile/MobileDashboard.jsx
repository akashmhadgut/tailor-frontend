...
const MobileDashboard = ({ onOpenCustomerModal }) => {
  const { columns, filteredOrders, setFilter, setView, updateOrderStatus } = useKanban();
...
<g opacity="0.2">
<path d="M36.498 -14V-0.600428" stroke="#F8C777" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M50.5684 5.42953L60.283 -4.28516" stroke="#F8C777" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M56.5977 19.5H69.9972" stroke="#F8C777" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M50.5684 33.5703L60.283 43.285" stroke="#F8C777" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M36.498 39.6016V53.0011" stroke="#F8C777" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M12.7148 43.285L22.4295 33.5703" stroke="#F8C777" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M3 19.5H16.3996" stroke="#F8C777" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M12.7148 -4.28516L22.4295 5.42953" stroke="#F8C777" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>
</g>
</svg>
...
<g opacity="0.2">
<path d="M36.5 50C55.0015 50 70 35.0015 70 16.5C70 -2.00154 55.0015 -17 36.5 -17C17.9985 -17 3 -2.00154 3 16.5C3 35.0015 17.9985 50 36.5 50Z" stroke="#7AC87A" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M26.4492 16.5086L33.1492 23.2086L46.5492 9.80859" stroke="#7AC87A" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>
</g>
</svg>
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] pb-[100px] px-4 font-inter">
      ...
      <div className="flex flex-col gap-6">
        ...
        {expandedStatus && (
          <div className={`${statusColors[mobileTiles.find(t => t.value === expandedStatus)?.color]?.bg || 'bg-gray-100'} rounded-[16px] p-[16px] flex flex-col gap-[16px]`}>
            {/* Expanded Header */}
            <div onClick={() => setExpandedStatus(null)} className="flex justify-between items-center cursor-pointer">
              <div className="flex items-center gap-3">
                <span className="text-[#424242] text-[24px] font-bold font-inter">
                  {mobileTiles.find(t => t.value === expandedStatus)?.title}
                </span>
